...
model1.save(f"testrun_industry{params['industry']['industry_scaling_baseline']}x{params['industry']['basic_material_scaling_baseline']}_with_nonCE_MAC_curves_run{datetime.today().strftime('%Y-%m-%d-%H-%M')}")
