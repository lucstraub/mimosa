...
def _get_mac_constraints(m: AbstractModel) -> Sequence[GeneralConstraint]:
    ...
    m.mitigation_costs_regional = Var(
        m.t,
        m.regions,
    ...
    constraints.extend(
        [
            RegionalConstraint(
                ...
                == m.mitigation_costs_regional[t, r] / m.GDP_gross[t, r],
            ...
            GlobalInitConstraint(
                lambda m: m.nonindustry_carbonprice_marg[0] == 0, "marginal init_carbon_price non-industry"
            ),
        ]
    )
        ...
        [
            GlobalConstraint(
                lambda m, t: (
                    ...
                    / soft_min(sum(m.mitigation_costs_regional[t, r] for r in m.regions))
                    if t > 0
