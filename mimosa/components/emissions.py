        ...
        [
            ...
            RegionalConstraint(
                ...
                - (
                    ...
                    * (m.emissions_industry_global_mitigation[t] + m.emissions_other_global_mitigation[t])
            ...
            GlobalConstraint(
                lambda m, t: (
                    ...
                    == m.emissions_other_global_mitigation[t] + m.emissions_industry_global_mitigation[t]
                    if t > 0
                    else Constraint.Skip
                ),
                "global_emissions",
    ...
    **and** if a carbon budget is specified. Otherwise, this constraint is ignored.
    ...
    constraints.extend(
        [
            ...
            GlobalConstraint(
                lambda m, t: (
                    m.emissions_industry_global_mitigation[t] - m.emissions_industry_global_mitigation[t - 1]
                    >= m.dt
                    * m.inertia_global
                    * m.emissions_industry_global_baseline[t]
